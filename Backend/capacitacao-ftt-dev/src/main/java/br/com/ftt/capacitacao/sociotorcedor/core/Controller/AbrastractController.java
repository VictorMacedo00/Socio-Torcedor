package br.com.ftt.capacitacao.sociotorcedor.core.Controller;

import br.com.ftt.capacitacao.sociotorcedor.core.Service.IService;
...
public abstract class AbrastractController<T> extends ResponseAbstractController implements IController<T> {
